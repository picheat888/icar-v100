...
1. **เพิ่ม design token อีก 4–5 ตัว** — มี 13 สีที่ใช้ ≥3 ครั้งแต่ยังเป็น hex
   ที่ควรทำก่อน: `#6b7884` (18 ที่) · `#cbe6e2` · `#e08a1e` · `#9a3b34`
   และเทาอ่อน 5 เฉดที่แทบแยกไม่ออก (`#eef1f3` `#eef2f4` `#f1f3f5` `#f4f7f8` `#f6f8f9`) น่าจะรวบเหลือ 1–2 ค่า
2. **รวบ pattern ที่ยังซ้ำข้าม island** — 33 กลุ่มที่กฎเหมือนกันเป๊ะ ตัวหนัก:
   ปุ่มปิด modal 6 ชุด · กล่อง error โหลดพลาด 4 ชุด · หัวข้อ modal 4 ชุด · backdrop 3 ชุด · segmented control 4 ชุด
3. **หัว drawer 2 ขนาดไม่ตรงกัน** — `.dj-`/`.mr-` (`20px 24px`/17px) vs `.rq-` (`22px 26px`/18px)
