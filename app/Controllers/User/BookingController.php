...
class BookingController extends BaseController
{
    ...
    public function store()
    {
        ...
        log_activity($type === 'other' ? 'booking_submitted_other' : 'booking_submitted_self', ['code' => $bookings->makeCode($id)]);
    ...
    public function update()
    {
        ...
        log_activity('booking_updated', ['code' => $b['booking_code']]);
    ...
    public function cancel()
    {
        ...
        if ($booking['status'] === 'pending') {
            ...
            log_activity('booking_cancelled', ['code' => $booking['booking_code']]);
        ...
        if ($booking['status'] === 'approved') {
            ...
            log_activity('booking_cancel_requested', ['code' => $booking['booking_code']]);
    ...
    public function returnCar()
    {
        ...
        log_activity('booking_returned', ['code' => $booking['booking_code']]);
